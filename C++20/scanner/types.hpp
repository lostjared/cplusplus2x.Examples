...
namespace types {
    ...
    enum class KeywordType { KW_LET, KW_PROC, KW_DEFINE, KW_IF, KW_ELSE, KW_SWITCH, KW_WHILE, KW_FOR, KW_RETURN };
    inline std::vector<std::string> kwStr { "let", "proc", "define", "if", "else", "switch", "while", "for", "return" };
